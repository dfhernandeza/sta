...
class DashboardPeriodoTest(TestCase):
    def setUp(self):
        ...
        config.save(update_fields=['cuenta_cxc'])
    ...
    def test_filtra_facturas_por_mes_y_fecha_de_apertura(self):
        ...
        self.assertEqual(response.context['ingresos_mes'], Decimal('30000'))

...
PLAN = [
    ...
    ('PASIVOS', 'Pasivos Corrientes', 'Obligaciones Previsionales', 'Seguro Cesantia Por Pagar'),
    ...
    ('GASTOS ADMINISTRATIVOS', 'Recursos Humanos', 'Remuneraciones Adm', 'Seguro Cesantia Empleador'),
